...
public class RickAndMortyScene
{
    ...
    public void WriteToDir(string sceneId = null)
    {
        ...
        if(aiArt.character?.head3d != null)
        {
            ...
            //  src: "3d-headshot-pipeline/headshot/data/3d/dalai lama/7as7d7f8ds72"
            // dest: "heads3d/7as7d7f8ds72/..."
            string pathToGeneration = $"3d-headshot-pipeline/headshot/data/3d/{head3d.characterKey}/{head3d.selectedGeneration}_mesh";
