...
namespace OpenAI_API.Models
{
	...
	public class Model
	{
		...
		public static Model ChatGPTTurbo16k => new("gpt-3.5-turbo-16k") { OwnedBy = "openai" };

		/// <summary>
		/// Snapshot of gpt-3.5-turbo from March 1st 2023. Unlike gpt-3.5-turbo, this model will not receive updates, and will only be supported for a three month period ending on June 1st 2023.
		/// </summary>
		public static Model ChatGPTTurbo0301 => new("gpt-3.5-turbo-0301") { OwnedBy = "openai" };
		public static Model ChatGPT4_8k => new("gpt-4") { OwnedBy = "openai" };
		public static Model ChatGPT4_8k_functions => new("gpt-4-0613") { OwnedBy = "openai" };
		public static Model ChatGPT4_32k => new("gpt-4-32k") { OwnedBy = "openai" };
